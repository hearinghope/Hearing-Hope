    ...
    <div className={styles.ContactChoose}>
      ...
      <div className={styles.ChoosePoints}>
        ...
        <div className={styles.ChoosePoint}>
          <Image src='/certified.png' alt='certified' height={50} width={50} />
          <h3>Signia Certified Center</h3>
        </div>

        <div className={styles.ChoosePoint}>
          <Image src='/professionals.png' alt='certified' height={50} width={50} />
          <h3>Team of Professional Audiologists</h3>
        </div>

        <div className={styles.ChoosePoint}>
          <Image src='/equipments.png' alt='certified' height={50} width={50} />
          <h3>World Class Equipments</h3>
        </div>

        <div className={styles.ChoosePoint}>
          <Image src='/experience.png' alt='certified' height={60} width={60} />
          <h3>15+ years of experience</h3>
        </div>

        <div className={styles.ChoosePoint}>
          <Image src='/home.png' alt='certified' height={50} width={50} />
          <h3>Home visit facility</h3>
        </div>

        <div className={styles.ChoosePoint}>
          <Image src='/speech.png' alt='certified' height={40} width={40} />

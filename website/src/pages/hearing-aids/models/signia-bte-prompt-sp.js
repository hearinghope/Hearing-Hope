...
const BTEPromptSP = () => {
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "Product",
              "name": "Signia BTE Prompt SP",
              "image": "https://www.hearinghope.in/_next/image?url=%2FProducts%2FSigniaBTEPromptSP.png",
              "description": "Discover Signia BTE Prompt SP Hearing Aids for personalized hearing solutions at Hearing Hope. Get expert consultations and support.",
              "brand": {
                "@type": "Brand",
                "name": "Signia"
              },
              "url": "https://www.hearinghope.in/hearing-aids/models/signia-bte-prompt-sp",
              "aggregateRating": {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What types of hearing loss is the Signia BTE Prompt SP suitable for?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The Signia BTE Prompt SP is specifically designed for individuals with severe to profound hearing loss. It offers advanced features that enhance sound clarity and speech understanding in various environments."
      }
    },
    {
      "@type": "Question",
      "name": "How long does the battery last in the Signia BTE Prompt SP?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The battery life of the Signia BTE Prompt SP depends on usage, especially with features like wireless streaming. Typically, the battery can last several days under normal usage conditions before needing a replacement."
      }
    },
    {
      "@type": "Question",
      "name": "Can I connect the Signia BTE Prompt SP to my smartphone or other devices?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, the Signia BTE Prompt SP features wireless connectivity options that allow you to stream audio directly from smartphones, TVs, and other compatible devices, enhancing your listening experience."
      }
    },
    {
      "@type": "Question",
      "name": "Is the Signia BTE Prompt SP water-resistant?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The Signia BTE Prompt SP is designed to be robust and durable, with a level of water resistance that protects it from moisture and dust. However, it is not fully waterproof and should not be submerged in water."
      }
    },
    {
      "@type": "Question",
      "name": "How can I adjust the settings on my Signia BTE Prompt SP?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The Signia BTE Prompt SP comes with user-friendly controls that allow you to easily adjust volume and settings. Additionally, it can be connected to a mobile app for more detailed personalization and control over its functions."
...
/>
    ...
    <div className={styles.ProductImage}>
      <Image src='/Products/SigniaPromptPSP.png' layout='responsive' alt='Signia BTE Prompt SP' width={500} height={400} /> 
    </div>
